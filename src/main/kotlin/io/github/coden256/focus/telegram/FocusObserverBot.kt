...
import io.github.coden256.focus.telegram.commands.ActivateActionCommand
import io.github.coden256.focus.telegram.commands.DeleteActionCommand
import io.github.coden256.focus.telegram.commands.DeleteMessageCommand
import io.github.coden256.focus.telegram.commands.FocusObserverCommand
import io.github.coden256.focus.telegram.format.FocusableFormatter
...
import io.github.coden256.telegram.senders.deleteMessage
import io.github.coden256.telegram.senders.edit
import io.github.coden256.telegram.senders.editBuilder
import io.github.coden256.telegram.senders.send
import io.github.coden256.utils.combine
...
//            callbackUpdate(serializer.serialize(DeleteActionCommand("2")))
    ...
    fun onAllActions() = ability("actions") { upd ->
        ...
        val keyboard = keyboard(
            actions,
            formatter.keyboardActionColumns()
        ) { action ->
            KeyboardButton(
                action.action,
