...
class DefaultFocusableAnalyser(val repo: FocusableRepository) : FocusableAnalyser, Logging {
    ...
    private fun mapTimeline(timeline: io.github.coden256.focus.core.model.FocusableAttentionTimeline): FocusableTimelineEntityResponse {
    ...
    private fun mapAttention(instant: io.github.coden256.focus.core.model.DetailedAttentionInstant): AttentionEntityResponse {
